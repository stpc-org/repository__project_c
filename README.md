...
总之, 欢迎使用C系列的活塞火炮 (你也可以对其中任何一个版本进行改装(~~魔改~~)). 
...
|   [Cannon_C-CT08](https://github.com/SiriusZ-BOTTLE/PistonCannonsOfSpaceEngineers/blob/main/c_series/Cannon_C-CT08-dec/bp.sbc)   | 破限  |  维护终止  | 特高速, 2.5 x 轴向4活塞(水平) | **约905m/s**  |   A-   |                         CT08是过渡验证版本                          |
|   [Cannon_C-CT10](https://github.com/SiriusZ-BOTTLE/PistonCannonsOfSpaceEngineers/blob/main/c_series/Cannon_C-CT10-dec/bp.sbc)   | 破限  | **维护中** | 特高速, 3.5 x 轴向4活塞(水平) | **约1000m/s** |   A-   |               CT10, C系第一门破千速火炮, **推荐使用**               |
|   [Cannon_C-CT12](https://github.com/SiriusZ-BOTTLE/PistonCannonsOfSpaceEngineers/blob/main/c_series/Cannon_C-CT12-dec/bp.sbc)   | 破限  | **维护中** | 特高速, 3.5 x 轴向4活塞(水平) | **约1000m/s** |   A-   |  CT12, CT10的修改版本, 些许提升稳定性, 微量减少体积, **推荐使用**   |
